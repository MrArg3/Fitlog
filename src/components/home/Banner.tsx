        ...
        <section className="p-[16px]">
            <div className="font-oswald max-w-6xl mx-auto items-center justify-between bg-[#1a1d23] rounded-3xl grid gap-10 p-8 lg:grid-cols-2 lg:p-12 ">
                <div>
                    ...
                    <button className="font-inter bg-[#b2da00] font-medium text-black text-[14px]  py-2 px-4 rounded-xl hover:bg-[#a0c500] transition duration-300">Browse Workouts</button>
                </div>
                    <Image
                        src={banner}
                        alt="Banner"
