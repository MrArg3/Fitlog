...
const SaveButton = ({ workout }: { workout: IWorkout }) => {
        ...
        return (
            <div>
                <button className="flex w-full items-center justify-center gap-2 rounded-2xl border border-white px-4 py-2 transition-colors duration-300 hover:bg-[#17191f] sm:w-auto">
                    <span className="flex items-center" onClick={() => handleAddToSaved()}>
                        {icon.save}
                    </span>
